...
inhabitants = ['PEOPLE WHO SLEEP VERY LITTLE', 'VEGETARIANS', 'PEOPLE SPEAKING MANY LANGUAGES WEARING NO CLOTHING', 'ALL RACES OF MEN REPRESENTED WEARING RED CLOTHING', 'CHILDREN AND OLD PEOPLE', 'VARIOUS BIRDS AND FISH', 'LOVERS', 'PEOPLE WHO ENJOY EATING TOGETHER', 'PEOPLE WHO EAT A GREAT DEAL', 'COLLECTORS OF ALL TYPES', 'FRIENDS AND ENEMIES', 'PEOPLE WHO SLEEP ALMOST ALL THE TIME', 'VERY TALL PEOPLE', 'AMERICAN INDIANS', 'LITTLE BOYS', 'PEOPLE FROM MANY WALKS OF LIFE', 'NEGROS WEARING ALL COLORS', 'FRIENDS', 'FRENCH AND GERMAN SPEAKING PEOPLE', 'FISHERMEN AND FAMILIES', 'PEOPLE WHO LOVE TO READ']

fear = ['WOLVES','ALIENS','MERMAIDS','PIRATES','HONEY BADGERS','DINOSAURS','SHARKNADO','HORRIBLE MOVIES']

count = 0
for i in material:
    count+=1
    print('THE POEM NUMBER %s'%count)
    print('A HOUSE OF ' + i)
    print('      ' + choice(location))
    print('            USING ' + choice(light_source))
    print('                  INHABITED BY ' + choice(inhabitants))
    print('                         IN FEAR OF %s' %choice(fear))
    print('')
